// Pattern: Copy of AAA QN24 Wrath Origin Map
// ID: dgd8qzDMgMZbQb7c6
...
function handle_STATE_IDLE() {
  //if(overrideToDebugState()) { return; }
  if (_aaa_triggerForReal) {
...
export var _aaa_triggerForReal = false;
function handle_DIO(delta) {
  ...
  _aaa_triggerForReal = _switchDeltaSinceFalse > 500;
}
