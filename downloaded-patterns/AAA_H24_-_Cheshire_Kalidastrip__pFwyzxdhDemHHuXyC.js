// Pattern: AAA H24 - Cheshire Kalidastrip
// ID: pFwyzxdhDemHHuXyC
...
*/
pic = makePIController(0.2, 0.15, 50, 0, 400);
...
// TODO JLOM Debug ghost flashes after pausing audio. Simple filter on frequencyData, maybe?
// ...or formalize a simple min-brightness AKA vHack?

export function beforeRender(delta) {
  sensitivity = calcPIController(
    pic,
...
// TODO JLOM REVISIT VHACK
export var aaaVHack = 0;
...
export function render(index) {
  ...
  */
  v =
    (arrayLerp(frequencyData, i) * 4 * sensitivity - arrayLerp(averages, i)) *
    (arrayLerp(averages, i) * 1000 + 0.5);
  ...
  // Decay each pixel's brightness by `fade` per frame and re-add the calculated v
...
function simulateSound() {
  ...
  beat *= 0.02 * pow(beat, 4); // Scale magnitude and make concave-up
